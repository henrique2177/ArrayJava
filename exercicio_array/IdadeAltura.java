...
public class IdadeAltura {
	...
	public static void main(String[] args) {
		...
		System.out.println("Primeira pessoa idade: " + idade[0] + " Altura: " +altura[0]);
		System.out.println("---------------------------------------");
		
		System.out.println("Segunda pessoa idade: " + idade[1]  + " Altura: " + altura[1]);
		System.out.println("---------------------------------------");
		
		System.out.println("Terceira pessoa idade: " + idade[2]  + " Altura: " + altura[2]);
		System.out.println("---------------------------------------");
		
		System.out.println("Quarta pessoa idade: " + idade[3]  + " Altura: " + altura[3]);
		System.out.println("---------------------------------------");
		
		System.out.printf("Quinta pessoa idade: " + idade[4]  + " Altura: " + altura[4]);
		System.out.println("---------------------------------------");
