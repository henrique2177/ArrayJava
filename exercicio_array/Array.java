...
public class Array {
	...
	public static void main(String[] args) {
		...
		if (opcao == 1) {
			...
			System.out.println("A média da nota de Prtugues " + nota[0] + " + Matematica + " + nota[1] + " Quimica + "
					+ nota[2] + " Geografia " + nota[3] + " é de :" + result);

		} else if (opcao == 2) {
			result = (nota[0] + nota[1] + nota[2] + nota[3]) / 4;
			System.out.println("A média da nota de Portugues " + nota[0] + " + Matematica + " + nota[1] + " Quimica + "
					+ nota[2] + " Geografia " + nota[3] + " é de :" + result);
		} else {
